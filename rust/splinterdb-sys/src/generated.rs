...
pub const SPLINTERDB_MAX_VALUE_SIZE: u32 = 127;
...
>;
pub type decode_message_value_fn = ::std::option::Option<
    unsafe extern "C" fn(
...
pub struct data_config {
    ...
    pub decode_message_value: decode_message_value_fn,
...
fn bindgen_test_layout_data_config() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<data_config>())).decode_message_value as *const _ as usize
        },
        144usize,
        concat!(
            "Offset of field: ",
            stringify!(data_config),
            "::",
            stringify!(decode_message_value)
        )
    );
    assert_eq!(
...
extern "C" {
    pub fn splinterdb_insert_value(
...
extern "C" {
    pub fn splinterdb_lookup_result_found(result: *mut splinterdb_lookup_result) -> bool;
}
extern "C" {
    pub fn splinterdb_lookup_result_size(result: *mut splinterdb_lookup_result) -> usize;
}
extern "C" {
    pub fn splinterdb_lookup_result_data(
        result: *mut splinterdb_lookup_result,
    ) -> *mut ::std::os::raw::c_void;
}
extern "C" {
    pub fn splinterdb_lookup_message(
        kvs: *const splinterdb,
        key_length: usize,
        key: *const ::std::os::raw::c_char,
        result: *mut splinterdb_lookup_result,
...
extern "C" {
    pub fn splinterdb_lookup_value(
        kvsb: *const splinterdb,
        key_len: usize,
        key: *const ::std::os::raw::c_char,
        val_buffer_len: usize,
        out_val_buffer: *mut ::std::os::raw::c_char,
        val_bytes: *mut usize,
...
extern "C" {
    pub fn splinterdb_iterator_get_current_message(
...
extern "C" {
    pub fn splinterdb_iterator_get_current_value(
        iter: *mut splinterdb_iterator,
        key_len: *mut usize,
        key: *mut *const ::std::os::raw::c_char,
        val_len: *mut usize,
